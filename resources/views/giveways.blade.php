                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="page-title-heading mg-bt-12">
                                <h1 class="heading text-center">Giveways</h1>
                            </div>
                ...
                <div class="themesflat-container">
                    <div class="row">
                        <div class="fl-blog fl-item2 col-lg-4 col-md-6">
                            <article class="sc-card-article">
                                <div class="card-media">
                                    <a href="blog-details.php"><img src="assets/images/blog/thumb-1.jpg" alt=""></a>
                                </div>
                                <div class="meta-info">
                                    <div class="author">
                                        <div class="avatar">
                                ...
                                <div class="text-article">
                                    <h3><a href="blog-details.php">The next big trend in crypto</a></h3>
                        ...
                        <div class="fl-blog fl-item2 col-lg-4 col-md-6">
                            <article class="sc-card-article">
                                <div class="card-media">
                                    <a href="blog-details.php"><img src="assets/images/blog/thumg-3-1.jpg" alt=""></a>
                                </div>
                                <div class="meta-info">
                                    <div class="author">
                                        <div class="avatar">
                                ...
                                <a href="blog-details.php" class="sc-button fl-button pri-3"><span>Read More</span></a>
                            </article>
                        </div>
                        <div class="fl-blog fl-item2 col-lg-4 col-md-6">
                            <article class="sc-card-article">
                                <div class="card-media">
                                    <a href="blog-details.php"><img src="assets/images/blog/thumb-4.jpg" alt=""></a>
                                </div>
                                <div class="meta-info">
                                    <div class="author">
                                        <div class="avatar">
                        ...
                        <div class="fl-blog fl-item2 col-lg-4 col-md-6">
                            <article class="sc-card-article">
                                <div class="card-media">
                                    <a href="blog-details.php"><img src="assets/images/blog/thumb-2.jpg" alt=""></a>
                                </div>
                                <div class="meta-info">
                                    <div class="author">
                                        <div class="avatar">
                        ...
                        <div class="fl-blog fl-item2 col-lg-4 col-md-6">
                            <article class="sc-card-article">
                                <div class="card-media">
                                    <a href="blog-details.php"><img src="assets/images/blog/thumb-5.jpg" alt=""></a>
                                </div>
                                <div class="meta-info">
                                    <div class="author">
                                        <div class="avatar">
                        ...
                        <div class="fl-blog fl-item2 col-lg-4 col-md-6">
                            <article class="sc-card-article">
                                <div class="card-media">
                                    <a href="blog-details.php"><img src="assets/images/blog/thumb-6-1.jpg" alt=""></a>
                                </div>
                                <div class="meta-info">
                                    <div class="author">
                                        <div class="avatar">
