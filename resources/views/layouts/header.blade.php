...
$phone_number1 = "+91 243225535";
$phone_number2 = "+91 34535355";
$email_address1 = "info@rtet.com";
$email_address2 = "info@werwerw.com";
$address = "Hisar Road, Sirsa";
?>
<!DOCTYPE html>
                                ...
                                <div class="wrap-box flex">
                                    ...
                                    <nav id="main-nav" class="main-nav">
                                        <ul id="menu-primary-menu" class="menu">
                                            ...
                                            <li class="menu-item ">
                                                <a href="Airdrop.php">Crypto Airdrop</a>
                                            </li>
                                            <li class="menu-item ">
                                                <a href="nft.php">Free NFT</a>
                                            </li>
                                            <li class="menu-item ">
                                                <a href="ido.php">Ongoing IDO</a>
                                            </li>
                                            <li class="menu-item ">
                                                <a href="giveways.php">Giveways</a>
                                            </li>
                                            <li class="menu-item ">
